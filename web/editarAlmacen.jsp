        ...
        <div class="container">      
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="container">
                        <form class="form-horizontal" action="editarAlmacen.jsp">
                            <fieldset>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editarAlmacen.jsp?id1=<%=temp.getId_a()%>" class="edit" title="Editar" data-toggle="tooltip"  id="eliminar" name="Editar">Editar</a> 
                    ...
                    <form class="form-horizontal" action="editarAlmacen.jsp"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <br>
                                <br>
                                <a href="editarAlmacen.jsp?id100=actualizar" class="edit" title="Editar" data-toggle="tooltip"  id="eliminar" name="Editar">ACTUALIZAR</a> 
                            </div>
                        </div>
