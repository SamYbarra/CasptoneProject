...
<div class="main-body-content w-100 ets-pt">
    <div class="table-responsive bg-light">
        <div class="container">
            <form class="form-horizontal" action="eliminarAlmacen.jsp">
                <fieldset>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="eliminarAlmacen.jsp?id=<%=temp5.getId_a()%>" class="edit" title="Eliminar" data-toggle="tooltip"  id="eliminar" name="eliminar">Eliminar</a></td>
