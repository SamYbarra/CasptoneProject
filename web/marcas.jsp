        ...
        <div class="container">      
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="container">
                        <form class="form-horizontal" action="marcas.jsp">
                            <fieldset>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=temp1.getNom()%></td>
                                        <td>
                                            <a href="marcas.jsp?id1=<%=temp1.getId_a()%>" class="edit" title="Editar" data-toggle="tooltip"  id="eliminar" name="Editar">Editar</a> 
                                            <a href="marcas.jsp?id=<%=temp1.getId_a()%>" class="edit" title="Eliminar" data-toggle="tooltip"  id="eliminar" name="eliminar">Eliminar</a>
                                        </td>
                                    </tr>
                                    <%
                                        }%>
                    ...
                    <form class="form-horizontal" action="marcas.jsp"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <br>
                                <br>
                                <a href="marcas.jsp?idx=actualizar" class="edit" title="Actualizar" data-toggle="Actualizar"  id="Actualizar" name="Actualizar">ACTUALIZAR</a> 
                            </div>
                        </div>
