        ...
        <div class="container">      
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="container">
                        <form class="form-horizontal" action="tipoAlmacen.jsp">
                            <fieldset>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=temp1.getNom()%></td>
                                        <td>
                                            <a href="tipoAlmacen.jsp?id1=<%=temp1.getId_a()%>" class="edit" title="Editar" data-toggle="tooltip"  id="eliminar" name="Editar">Editar</a> 
                                            <a href="tipoAlmacen.jsp?id=<%=temp1.getId_a()%>" class="edit" title="Eliminar" data-toggle="tooltip"  id="eliminar" name="eliminar">Eliminar</a>   
                                        </td>
                                    </tr>
                                    <%
                                        }%>
                    ...
                    <form class="form-horizontal" action="tipoAlmacen.jsp"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <br>
                                <br>
                                <a href="tipoAlmacen.jsp?idx=actualizar" class="edit" title="Actualizar" data-toggle="Actualizar"  id="Actualizar" name="Actualizar">ACTUALIZAR</a> 
                            </div>
                        </div>
